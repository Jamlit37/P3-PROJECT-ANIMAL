...
const Visit = () => (
  <Space direction="vertical">
    ...
    <Image width={950} style={{ justifyContent: 'center', marginLeft: '33%' }} src={map}/>
    <Text strong>How to get here!</Text>
    <Text>Various options include train, bus, bike or car.</Text>
    <Text>Located 4 minutes from the Mornington Peninsula Fwy, there is plenty of free street parking.</Text>
    ...
    <Image id="crocbanner" width={'95vw'} height={'700px'} src={crocbanner} />
